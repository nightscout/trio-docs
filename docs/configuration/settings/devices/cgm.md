...
!!! warning "You must build the `dev` branch to use the Accu-Chek SmartGuide CGM at this time"
    The Accu-Chek SmartGuide CGM is in `dev` and is experimental for now
