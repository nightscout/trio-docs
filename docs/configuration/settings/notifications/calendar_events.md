...
![Trio Calendar](img/trio-calendar.png){ width="300px" }
{ align=center }
...
When enabled, the calendar event created will indicate where the current glucose reading is in relation to your [statistical target range](settings/user_interface.md#show-low-high-thresholds).
