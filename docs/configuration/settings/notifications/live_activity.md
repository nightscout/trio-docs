...
=== "Simple"
    ...
    ![Simple Widget](img/la-simple.png){ width="500px" }
    { align=center }
    
=== "Detailed"
    The detailed widget displays your live glucose graph.  
    
    ![Detailed Widget](img/la-detailed.png){ width="600px" }
    { align=center }
    ...
    ![Widget Configuration](img/widget-configuration.png){ width="400px" }
    { align=center }
