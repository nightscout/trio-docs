...
| [**Minimum Safety Threshold**](../settings/therapy/units-limits.md#minimum-safety-threshold) | decimal <br> (60 mg/dL) | Settings → Therapy → Units and Limits → Minimum Safety Threshold | **Threshold Setting** | decimal <br> (60) | Settings → Dynamic ISF → Threshold Setting |
