...
| **[High Glucose Target](../settings/algorithm/smb-settings.md#high-glucose-target)** | **dial** | *decimal <br> (110 mg/dL / 6.1 mmol/L)* | <span style="color: #ff8340;">**... When Blood Glucose is Over (mg/dl)**</span> | <span style="color: #ff8340;">**typed value**</span> | *decimal <br> (110 / 6.1)* | <span style="color: #ff8340;">**Name <br> Entry Type <br> Format <br> *Now only appears when Enable SMB With High Glucose is ON***</span> |
