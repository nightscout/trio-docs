...
- **Community troubleshooting**: Post logs to the Trio [`#bug-reports`](https://discord.com/channels/1020905149037813862/1239982832026255521) channel on **Discord** or relevant **Facebook** groups when volunteers ask for them to help diagnose an issue.  
  If Discord complains about the file size, compress the two files into an archive before sending.
