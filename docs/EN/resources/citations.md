...
The first place to start if you want to learn more about the underlying algorithm, is the extensive [OpenAPS documentation](https://openaps.readthedocs.io/). OpenAPS is the underlying algorithm that Open-iAPS implements to control blood sugar, with small modifications mostly pertaining to the Dynamic settings. 
...
## Community Support
There are many help groups surrounding Open-iAPS. It is likely someone else has has your issue in the past. Please visit the [Discord](https://discord.gg/ptkk2Y264Z) and [Facebook](https://www.facebook.com/groups/1351938092206709) channels and review previous chat logs to find a solution. If you are a BC Diabetes Looper, please request a link to their Slack group from your case manager.
