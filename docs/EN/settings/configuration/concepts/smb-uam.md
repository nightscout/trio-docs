...
There are numerous settings related to enabling SMBs in Open-iAPS. Below is the presidence of the settings Open-iAPS uses when deciding whether to enable or disable SMB:
