...
Trio requires a relatively recent phone. The faster the phone, the better for the algorithm and battery life. You need a minimum version of the mobile operating software, called the phone's 'iOS', to be installed on your phone. Trio is compatible with phones running on iOS 16 or newer.
