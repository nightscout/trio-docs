...
???+ abstract "Summary for Browser Build with Links (click to open/close)"
    ...
    * Use the template to [Save Your Information](#make-a-secrets-reference-file){: target="_blank" }
    ...
    * [How to Build the *Loop* App With a Web Browser](https://www.youtube.com/watch?v=kiu5ho0MTW8)
    ...
    You can think of the first part as a scavenger hunt where you find or generate and save six <code>Secrets</code>. All six secrets should be saved in your [`Secrets` reference file](#make-a-secrets-reference-file). You will need to be able to use them again.
