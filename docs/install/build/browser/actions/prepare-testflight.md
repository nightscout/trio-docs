...
1. You can add or remove emails to the Internal Test Group as any time
    ...
    * If building for a minor child, you will send the invitation to yourself or another person because a minor child is not authorized to use *TestFlight*: See [TestFlight for a Child](../install-from-testflight.md#testflight-for-a-child)
